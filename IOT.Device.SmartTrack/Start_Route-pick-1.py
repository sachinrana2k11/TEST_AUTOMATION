...
from hardware import gpshardware,rfidhardware,camerahardware #,shuthardware,panichardware
import models as md
import peewee as pw
...
c = ConfigHelper('C:\\shunya\\IOT.Device.SmartTrack\\CONFIG_FILES\\Demo_Route_pick_1.INI')
